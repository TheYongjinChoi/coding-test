  ...
  body.innerHTML = `
    ...
    <div class="mission-section">
      ...
      <div class="shortcut-list">
        ...
        <div class="shortcut-item"><span class="shortcut-desc">할당 연산자 &lt;-</span><span class="shortcut-keys"><kbd>Alt</kbd><kbd>-</kbd><span class="shortcut-sep">/</span><kbd>Option</kbd><kbd>-</kbd></span></div>
        <div class="shortcut-item"><span class="shortcut-desc">파이프 %&gt;%</span><span class="shortcut-keys"><kbd>Ctrl</kbd><kbd>Shift</kbd><kbd>M</kbd><span class="shortcut-sep">/</span><kbd>⌘</kbd><kbd>Shift</kbd><kbd>M</kbd></span></div>
        <div class="shortcut-item"><span class="shortcut-desc">들여쓰기</span><span class="shortcut-keys"><kbd>Tab</kbd></span></div>
        <div class="shortcut-item"><span class="shortcut-desc">내어쓰기</span><span class="shortcut-keys"><kbd>Shift</kbd><kbd>Tab</kbd></span></div>
        <div class="shortcut-group-label">실행</div>
        <div class="shortcut-item"><span class="shortcut-desc">현재 줄 실행</span><span class="shortcut-keys"><kbd>Ctrl</kbd><kbd>Enter</kbd><span class="shortcut-sep">/</span><kbd>⌘</kbd><kbd>Enter</kbd></span></div>
        <div class="shortcut-item"><span class="shortcut-desc">전체 실행</span><span class="shortcut-keys"><kbd>Ctrl</kbd><kbd>Shift</kbd><kbd>Enter</kbd><span class="shortcut-sep">/</span><kbd>⌘</kbd><kbd>Shift</kbd><kbd>Enter</kbd></span></div>
        <div class="shortcut-group-label">편집</div>
        <div class="shortcut-item"><span class="shortcut-desc">주석 토글</span><span class="shortcut-keys"><kbd>Ctrl</kbd><kbd>Shift</kbd><kbd>C</kbd><span class="shortcut-sep">/</span><kbd>⌘</kbd><kbd>Shift</kbd><kbd>C</kbd></span></div>
        <div class="shortcut-item"><span class="shortcut-desc">줄 삭제</span><span class="shortcut-keys"><kbd>Ctrl</kbd><kbd>D</kbd><span class="shortcut-sep">/</span><kbd>⌘</kbd><kbd>D</kbd></span></div>
        <div class="shortcut-item"><span class="shortcut-desc">줄 복제</span><span class="shortcut-keys"><kbd>Ctrl</kbd><kbd>Shift</kbd><kbd>D</kbd><span class="shortcut-sep">/</span><kbd>⌘</kbd><kbd>Shift</kbd><kbd>D</kbd></span></div>
        <div class="shortcut-item"><span class="shortcut-desc">줄 위로 이동</span><span class="shortcut-keys"><kbd>Alt</kbd><kbd>↑</kbd><span class="shortcut-sep">/</span><kbd>Option</kbd><kbd>↑</kbd></span></div>
        <div class="shortcut-item"><span class="shortcut-desc">줄 아래로 이동</span><span class="shortcut-keys"><kbd>Alt</kbd><kbd>↓</kbd><span class="shortcut-sep">/</span><kbd>Option</kbd><kbd>↓</kbd></span></div>
      </div>
    </div>
  `;
